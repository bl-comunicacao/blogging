...
describe("#GET /posts/:id", () => {
  ...
  it("Deve retornar o post criado pelo ID", async () => {
    ...
    const res = await request(app).get(`/posts/${postCriado.id}`)
